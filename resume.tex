...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubhead
      ...
      {Software Engineer}
      \resumeItemListStart
        \resumeItem{Implementing a web-based interface to provide a better way to create ETL configuration of datasets for the business analyst team. Reducing the time to build the configuration, doing analyst and testing the configuration from several weeks to 3-5 days per dataset}
        \resumeItem{Took care of all the RPC calls between components of the prototype of next-gen data infrastructure}
        \resumeItem{Implemented a new transformation tool using Spark which converts raw data to the internal format much faster. It also reduces lots of manual work for my team}
    ...
    \resumeSubhead
      ...
      \resumeItemListStart
        ...
        \resumeItem{One of the internal webs can serve a few hundred API heavy-computing requests per second}
