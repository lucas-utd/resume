...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubhead
      ...
      {Software Engineer}
      \resumeItemListStart
        \resumeItem{Implementing a web-based interface to provide a better way to create ETL configuration of datasets for the Business Analyst team. This helps the BAs to build the configuration for only 4 weeks instead of per dataset instead of months doing analyst and testing the configuration}
        \resumeItem{Maintaining a fork of Spark datasources for internal usage}
