...
\section{Summary}
  \resumeItemListStart
    ...
    \resumeItem{Able to understand different views very quickly and apply them to real-world problems}
    \resumeItem{Determine to be a world class software engineer in near future}
  \resumeItemListEnd
