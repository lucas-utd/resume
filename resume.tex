...
\section{Summary}
  \resumeItemListStart
    \resumeItem{Software engineer with good knowledge about algorithms and data structures}
    \resumeItem{Good understanding of database systems, distributed systems, network programming}
