...
\section{Summary}
  \resumeItemListStart
    \resumeItem{Intensive knowledge about algorithms and data structures}
    \resumeItem{Good understanding of database systems, distributed systems and network programming}
  \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubhead
      ...
      \resumeItemListStart
        ...
        \resumeItem{My thesis focused on how I clean, transform and model data, to help the algorithms understand data better and give better result}
