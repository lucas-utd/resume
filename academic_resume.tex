...
\section{Summary}
  \resumeItemListStart
    ...
    \resumeItem{Research interests: database management systems, data storage, distributed systems}
  \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubhead
      ...
      \resumeItemListStart
        ...
        \resumeItem{Cleaned and transformed data to help the algorithms understand data better and give better result}
        \resumeItem{Applied some state-of-the-art techniques such as Deep learning (RNNs and LSTM) and Machine learning (Support Vector Machines)}
      \resumeItemListEnd
    \resumeSubheadTwo
